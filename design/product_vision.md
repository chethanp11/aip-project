...
PRISM helps teams reduce reporting sprawl and is surfaced as its own Analyst Action product, separate from Research.
...
## Analyst Actions Product Split

Analyst Actions now expose PRISM and Research as separate products in the unified shell. PRISM focuses on report rationalization, duplicate detection, report overlap analysis, and consolidation planning. Research focuses on business context discovery, glossary and metric lookup, historical artifact retrieval, and governed KMS-backed organizational intelligence.
